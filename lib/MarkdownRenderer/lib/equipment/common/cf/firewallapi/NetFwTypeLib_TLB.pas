...
const
  ...
  IID_INetFwRemoteAdminSettings
    : TGUID = '{D4BECDDF-6F73-4A83-B832-9C66874CD20E}';
  ...
  IID_INetFwAuthorizedApplication
    : TGUID = '{B5E64FFA-C2C5-444E-A301-FB5E00018050}';
  IID_INetFwAuthorizedApplications
    : TGUID = '{644EFD52-CCF9-486C-97A2-39F352570B30}';
  IID_INetFwServiceRestriction
    : TGUID = '{8267BBE3-F890-491C-B7B6-2DB1EF0E5D2B}';
  ...
  CLASS_NetFwAuthorizedApplication
    : TGUID = '{EC9846B3-2762-4A6B-A214-6ACB603462D2}';
...
type
  ...
  INetFwRemoteAdminSettings = interface(IDispatch)
    ...
    property IpVersion: NET_FW_IP_VERSION_ read Get_IpVersion
      write Set_IpVersion;
    property Scope: NET_FW_SCOPE_ read Get_Scope write Set_Scope;
    property RemoteAddresses: WideString read Get_RemoteAddresses
      write Set_RemoteAddresses;
  ...
  INetFwIcmpSettings = interface(IDispatch)
    ...
    procedure Set_AllowOutboundDestinationUnreachable(allow: WordBool);
      safecall;
    ...
    property AllowOutboundDestinationUnreachable: WordBool
      read Get_AllowOutboundDestinationUnreachable
      write Set_AllowOutboundDestinationUnreachable;
    property AllowRedirect: WordBool read Get_AllowRedirect
      write Set_AllowRedirect;
    property AllowInboundEchoRequest: WordBool read Get_AllowInboundEchoRequest
      write Set_AllowInboundEchoRequest;
    property AllowOutboundTimeExceeded: WordBool
      read Get_AllowOutboundTimeExceeded write Set_AllowOutboundTimeExceeded;
    property AllowOutboundParameterProblem: WordBool
      read Get_AllowOutboundParameterProblem
      write Set_AllowOutboundParameterProblem;
    property AllowOutboundSourceQuench: WordBool
      read Get_AllowOutboundSourceQuench write Set_AllowOutboundSourceQuench;
    property AllowInboundRouterRequest: WordBool
      read Get_AllowInboundRouterRequest write Set_AllowInboundRouterRequest;
    property AllowInboundTimestampRequest: WordBool
      read Get_AllowInboundTimestampRequest
      write Set_AllowInboundTimestampRequest;
    property AllowInboundMaskRequest: WordBool read Get_AllowInboundMaskRequest
      write Set_AllowInboundMaskRequest;
    property AllowOutboundPacketTooBig: WordBool
      read Get_AllowOutboundPacketTooBig write Set_AllowOutboundPacketTooBig;
  end;
  ...
  INetFwOpenPorts = interface(IDispatch)
    ...
    procedure Remove(portNumber: Integer;
      ipProtocol: NET_FW_IP_PROTOCOL_); safecall;
    function Item(portNumber: Integer; ipProtocol: NET_FW_IP_PROTOCOL_)
      : INetFwOpenPort; safecall;
  ...
  INetFwOpenPortsDisp = dispinterface
    ...
    procedure Remove(portNumber: Integer;
      ipProtocol: NET_FW_IP_PROTOCOL_); dispid 3;
    function Item(portNumber: Integer; ipProtocol: NET_FW_IP_PROTOCOL_)
      : INetFwOpenPort; dispid 4;
  ...
  INetFwAuthorizedApplication = interface(IDispatch)
    ...
    procedure Set_ProcessImageFileName(const imageFileName
      : WideString); safecall;
    function Get_IpVersion: NET_FW_IP_VERSION_; safecall;
    procedure Set_IpVersion(IpVersion: NET_FW_IP_VERSION_); safecall;
    function Get_Scope: NET_FW_SCOPE_; safecall;
    ...
    procedure Set_Enabled(Enabled: WordBool); safecall;
    property Name: WideString read Get_Name write Set_Name;
    property ProcessImageFileName: WideString read Get_ProcessImageFileName
      write Set_ProcessImageFileName;
    property IpVersion: NET_FW_IP_VERSION_ read Get_IpVersion
      write Set_IpVersion;
    property Scope: NET_FW_SCOPE_ read Get_Scope write Set_Scope;
    property RemoteAddresses: WideString read Get_RemoteAddresses
  ...
  INetFwAuthorizedApplications = interface(IDispatch)
    ...
    function Item(const imageFileName: WideString)
      : INetFwAuthorizedApplication; safecall;
    function Get__NewEnum: IUnknown; safecall;
    property Count: Integer read Get_Count;
    property _NewEnum: IUnknown read Get__NewEnum;
  end;
  ...
  INetFwAuthorizedApplicationsDisp = dispinterface
    ...
    function Item(const imageFileName: WideString)
      : INetFwAuthorizedApplication; dispid 4;
    property _NewEnum: IUnknown readonly dispid - 4;
  end;
  ...
  INetFwServiceRestriction = interface(IDispatch)
    ...
    procedure RestrictService(const serviceName: WideString;
      const appName: WideString; RestrictService: WordBool;
      serviceSidRestricted: WordBool); safecall;
    function ServiceRestricted(const serviceName: WideString;
      const appName: WideString): WordBool; safecall;
  ...
  INetFwServiceRestrictionDisp = dispinterface
    ...
    procedure RestrictService(const serviceName: WideString;
      const appName: WideString; RestrictService: WordBool;
      serviceSidRestricted: WordBool); dispid 1;
    function ServiceRestricted(const serviceName: WideString;
      const appName: WideString): WordBool; dispid 2;
  ...
  INetFwRule = interface(IDispatch)
    ...
    procedure Set_IcmpTypesAndCodes(const IcmpTypesAndCodes
      : WideString); safecall;
    ...
    property LocalAddresses: WideString read Get_LocalAddresses
      write Set_LocalAddresses;
    property RemoteAddresses: WideString read Get_RemoteAddresses
      write Set_RemoteAddresses;
    property IcmpTypesAndCodes: WideString read Get_IcmpTypesAndCodes
      write Set_IcmpTypesAndCodes;
    ...
    property InterfaceTypes: WideString read Get_InterfaceTypes
      write Set_InterfaceTypes;
    property Enabled: WordBool read Get_Enabled write Set_Enabled;
    ...
    property EdgeTraversal: WordBool read Get_EdgeTraversal
      write Set_EdgeTraversal;
  ...
  INetFwProfile = interface(IDispatch)
    ...
    function Get_UnicastResponsesToMulticastBroadcastDisabled
      : WordBool; safecall;
    procedure Set_UnicastResponsesToMulticastBroadcastDisabled
    ...
    property FirewallEnabled: WordBool read Get_FirewallEnabled
      write Set_FirewallEnabled;
    property ExceptionsNotAllowed: WordBool read Get_ExceptionsNotAllowed
      write Set_ExceptionsNotAllowed;
    property NotificationsDisabled: WordBool read Get_NotificationsDisabled
      write Set_NotificationsDisabled;
    property UnicastResponsesToMulticastBroadcastDisabled: WordBool
      read Get_UnicastResponsesToMulticastBroadcastDisabled
      write Set_UnicastResponsesToMulticastBroadcastDisabled;
    property RemoteAdminSettings: INetFwRemoteAdminSettings
      read Get_RemoteAdminSettings;
    property IcmpSettings: INetFwIcmpSettings read Get_IcmpSettings;
    property GloballyOpenPorts: INetFwOpenPorts read Get_GloballyOpenPorts;
    property Services: INetFwServices read Get_Services;
    property AuthorizedApplications: INetFwAuthorizedApplications
      read Get_AuthorizedApplications;
  end;
  ...
  INetFwProfileDisp = dispinterface
    ...
    property AuthorizedApplications: INetFwAuthorizedApplications readonly
      dispid 10;
  end;
  ...
  INetFwPolicy = interface(IDispatch)
    ...
    function GetProfileByType(profileType: NET_FW_PROFILE_TYPE_)
      : INetFwProfile; safecall;
  ...
  INetFwPolicy2 = interface(IDispatch)
    ...
    function Get_FirewallEnabled(profileType: NET_FW_PROFILE_TYPE2_)
      : WordBool; safecall;
    procedure Set_FirewallEnabled(profileType: NET_FW_PROFILE_TYPE2_;
      Enabled: WordBool); safecall;
    function Get_ExcludedInterfaces(profileType: NET_FW_PROFILE_TYPE2_)
      : OleVariant; safecall;
    procedure Set_ExcludedInterfaces(profileType: NET_FW_PROFILE_TYPE2_;
      Interfaces: OleVariant); safecall;
    function Get_BlockAllInboundTraffic(profileType: NET_FW_PROFILE_TYPE2_)
      : WordBool; safecall;
    procedure Set_BlockAllInboundTraffic(profileType: NET_FW_PROFILE_TYPE2_;
      Block: WordBool); safecall;
    function Get_NotificationsDisabled(profileType: NET_FW_PROFILE_TYPE2_)
      : WordBool; safecall;
    procedure Set_NotificationsDisabled(profileType: NET_FW_PROFILE_TYPE2_;
      disabled: WordBool); safecall;
    function Get_UnicastResponsesToMulticastBroadcastDisabled
      (profileType: NET_FW_PROFILE_TYPE2_): WordBool; safecall;
    procedure Set_UnicastResponsesToMulticastBroadcastDisabled
      (profileType: NET_FW_PROFILE_TYPE2_; disabled: WordBool); safecall;
    function Get_Rules: INetFwRules; safecall;
    function Get_ServiceRestriction: INetFwServiceRestriction; safecall;
    procedure EnableRuleGroup(profileTypesBitmask: Integer;
      const group: WideString; enable: WordBool); safecall;
    function IsRuleGroupEnabled(profileTypesBitmask: Integer;
      const group: WideString): WordBool; safecall;
    procedure RestoreLocalFirewallDefaults; safecall;
    function Get_DefaultInboundAction(profileType: NET_FW_PROFILE_TYPE2_)
      : NET_FW_ACTION_; safecall;
    procedure Set_DefaultInboundAction(profileType: NET_FW_PROFILE_TYPE2_;
      Action: NET_FW_ACTION_); safecall;
    function Get_DefaultOutboundAction(profileType: NET_FW_PROFILE_TYPE2_)
      : NET_FW_ACTION_; safecall;
    procedure Set_DefaultOutboundAction(profileType: NET_FW_PROFILE_TYPE2_;
      Action: NET_FW_ACTION_); safecall;
    function Get_IsRuleGroupCurrentlyEnabled(const group: WideString)
      : WordBool; safecall;
    ...
    property FirewallEnabled[profileType: NET_FW_PROFILE_TYPE2_]: WordBool
      read Get_FirewallEnabled write Set_FirewallEnabled;
    property ExcludedInterfaces[profileType: NET_FW_PROFILE_TYPE2_]: OleVariant
      read Get_ExcludedInterfaces write Set_ExcludedInterfaces;
    property BlockAllInboundTraffic[profileType: NET_FW_PROFILE_TYPE2_]
      : WordBool read Get_BlockAllInboundTraffic
      write Set_BlockAllInboundTraffic;
    property NotificationsDisabled[profileType: NET_FW_PROFILE_TYPE2_]: WordBool
      read Get_NotificationsDisabled write Set_NotificationsDisabled;
    property UnicastResponsesToMulticastBroadcastDisabled
      [profileType: NET_FW_PROFILE_TYPE2_]: WordBool
      read Get_UnicastResponsesToMulticastBroadcastDisabled
      write Set_UnicastResponsesToMulticastBroadcastDisabled;
    property Rules: INetFwRules read Get_Rules;
    property ServiceRestriction: INetFwServiceRestriction
      read Get_ServiceRestriction;
    property DefaultInboundAction[profileType: NET_FW_PROFILE_TYPE2_]
      : NET_FW_ACTION_ read Get_DefaultInboundAction
      write Set_DefaultInboundAction;
    property DefaultOutboundAction[profileType: NET_FW_PROFILE_TYPE2_]
      : NET_FW_ACTION_ read Get_DefaultOutboundAction
      write Set_DefaultOutboundAction;
    property IsRuleGroupCurrentlyEnabled[const group: WideString]: WordBool
      read Get_IsRuleGroupCurrentlyEnabled;
    property LocalPolicyModifyState: NET_FW_MODIFY_STATE_
      read Get_LocalPolicyModifyState;
  end;
  ...
  INetFwPolicy2Disp = dispinterface
    ...
    property FirewallEnabled[profileType: NET_FW_PROFILE_TYPE2_]
      : WordBool dispid 2;
    property ExcludedInterfaces[profileType: NET_FW_PROFILE_TYPE2_]
      : OleVariant dispid 3;
    property BlockAllInboundTraffic[profileType: NET_FW_PROFILE_TYPE2_]
      : WordBool dispid 4;
    property NotificationsDisabled[profileType: NET_FW_PROFILE_TYPE2_]
      : WordBool dispid 5;
    property UnicastResponsesToMulticastBroadcastDisabled
      [profileType: NET_FW_PROFILE_TYPE2_]: WordBool dispid 6;
    property Rules: INetFwRules readonly dispid 7;
    property ServiceRestriction: INetFwServiceRestriction readonly dispid 8;
    procedure EnableRuleGroup(profileTypesBitmask: Integer;
      const group: WideString; enable: WordBool); dispid 9;
    function IsRuleGroupEnabled(profileTypesBitmask: Integer;
      const group: WideString): WordBool; dispid 10;
    procedure RestoreLocalFirewallDefaults; dispid 11;
    property DefaultInboundAction[profileType: NET_FW_PROFILE_TYPE2_]
      : NET_FW_ACTION_ dispid 12;
    property DefaultOutboundAction[profileType: NET_FW_PROFILE_TYPE2_]
      : NET_FW_ACTION_ dispid 13;
    property IsRuleGroupCurrentlyEnabled[const group: WideString]
      : WordBool readonly dispid 14;
  ...
  INetFwMgr = interface(IDispatch)
    ...
    procedure IsPortAllowed(const imageFileName: WideString;
      IpVersion: NET_FW_IP_VERSION_; portNumber: Integer;
      const localAddress: WideString; ipProtocol: NET_FW_IP_PROTOCOL_;
      out allowed: OleVariant; out restricted: OleVariant); safecall;
    procedure IsIcmpTypeAllowed(IpVersion: NET_FW_IP_VERSION_;
      const localAddress: WideString; type_: Byte; out allowed: OleVariant;
      out restricted: OleVariant); safecall;
    property LocalPolicy: INetFwPolicy read Get_LocalPolicy;
    property CurrentProfileType: NET_FW_PROFILE_TYPE_
      read Get_CurrentProfileType;
  end;
  ...
  INetFwMgrDisp = dispinterface
    ...
    procedure IsPortAllowed(const imageFileName: WideString;
      IpVersion: NET_FW_IP_VERSION_; portNumber: Integer;
      const localAddress: WideString; ipProtocol: NET_FW_IP_PROTOCOL_;
      out allowed: OleVariant; out restricted: OleVariant); dispid 4;
    procedure IsIcmpTypeAllowed(IpVersion: NET_FW_IP_VERSION_;
      const localAddress: WideString; type_: Byte; out allowed: OleVariant;
      out restricted: OleVariant); dispid 5;
  end;
...
{$ENDIF}
  ...
  public
    ...
    procedure Disconnect; override;
    property DefaultInterface: INetFwAuthorizedApplication
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TNetFwAuthorizedApplicationProperties
...
{$ENDIF}
  ...
  protected
    ...
    function Get_UnicastResponsesToMulticastBroadcastDisabled
      (profileType: NET_FW_PROFILE_TYPE2_): WordBool;
    procedure Set_UnicastResponsesToMulticastBroadcastDisabled
      (profileType: NET_FW_PROFILE_TYPE2_; disabled: WordBool);
  ...
  public
    ...
    procedure Disconnect; override;
    procedure EnableRuleGroup(profileTypesBitmask: Integer;
      const group: WideString; enable: WordBool);
    function IsRuleGroupEnabled(profileTypesBitmask: Integer;
...
const
  CServerData: TServerData = (ClassID: '{2C5BC43E-3369-4C33-AB0C-BE9469677AF4}';
    IntfIID: '{AF230D27-BABA-4E42-ACED-F524F22CFCE2}'; EventIID: '';
...
procedure TNetFwRuleProperties.Set_ApplicationName(const imageFileName
  : WideString);
{ Warning: The property ApplicationName has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant as a passthrough. }
...
procedure TNetFwRuleProperties.Set_RemoteAddresses(const remoteAddrs
  : WideString);
{ Warning: The property RemoteAddresses has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant as a passthrough. }
...
procedure TNetFwRuleProperties.Set_IcmpTypesAndCodes(const IcmpTypesAndCodes
  : WideString);
{ Warning: The property IcmpTypesAndCodes has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant as a passthrough. }
...
procedure TNetFwRuleProperties.Set_InterfaceTypes(const InterfaceTypes
  : WideString);
{ Warning: The property InterfaceTypes has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant as a passthrough. }
...
class function CoNetFwOpenPort.CreateRemote(const MachineName: string)
  : INetFwOpenPort;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_NetFwOpenPort)
    as INetFwOpenPort;
end;

procedure TNetFwOpenPort.InitServerData;
const
  CServerData: TServerData = (ClassID: '{0CA545C6-37AD-4A6C-BF92-9F7610067EF5}';
    IntfIID: '{E0483BA0-47FF-4D9C-A6D6-7741D0B195F7}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
procedure TNetFwOpenPortProperties.Set_Protocol
...
procedure TNetFwOpenPortProperties.Set_RemoteAddresses(const remoteAddrs
  : WideString);
{ Warning: The property RemoteAddresses has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant as a passthrough. }
...
begin
  Result := CreateComObject(CLASS_NetFwAuthorizedApplication)
    as INetFwAuthorizedApplication;
end;

class function CoNetFwAuthorizedApplication.CreateRemote(const MachineName
  : string): INetFwAuthorizedApplication;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_NetFwAuthorizedApplication)
    as INetFwAuthorizedApplication;
end;

procedure TNetFwAuthorizedApplication.InitServerData;
const
  CServerData: TServerData = (ClassID: '{EC9846B3-2762-4A6B-A214-6ACB603462D2}';
    IntfIID: '{B5E64FFA-C2C5-444E-A301-FB5E00018050}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
procedure TNetFwAuthorizedApplication.ConnectTo
  (svrIntf: INetFwAuthorizedApplication);
begin
  Disconnect;
  FIntf := svrIntf;
end;
...
function TNetFwAuthorizedApplication.GetDefaultInterface
  : INetFwAuthorizedApplication;
begin
  if FIntf = nil then
    Connect;
...
function TNetFwAuthorizedApplication.GetServerProperties
  : TNetFwAuthorizedApplicationProperties;
begin
  Result := FProps;
end;
{$ENDIF}
...
procedure TNetFwAuthorizedApplication.Set_ProcessImageFileName
  (const imageFileName: WideString);
...
procedure TNetFwAuthorizedApplication.Set_IpVersion
...
procedure TNetFwAuthorizedApplication.Set_RemoteAddresses(const remoteAddrs
  : WideString);
{ Warning: The property RemoteAddresses has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant as a passthrough. }
...
constructor TNetFwAuthorizedApplicationProperties.Create
  (AServer: TNetFwAuthorizedApplication);
begin
  inherited Create;
  FServer := AServer;
end;

function TNetFwAuthorizedApplicationProperties.GetDefaultInterface
  : INetFwAuthorizedApplication;
begin
  Result := FServer.DefaultInterface;
end;
...
procedure TNetFwAuthorizedApplicationProperties.Set_Name
...
function TNetFwAuthorizedApplicationProperties.Get_ProcessImageFileName
  : WideString;
begin
  Result := DefaultInterface.ProcessImageFileName;
end;

procedure TNetFwAuthorizedApplicationProperties.Set_ProcessImageFileName
  (const imageFileName: WideString);
{ Warning: The property ProcessImageFileName has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant as a passthrough. }
...
function TNetFwAuthorizedApplicationProperties.Get_IpVersion
  : NET_FW_IP_VERSION_;
begin
  Result := DefaultInterface.IpVersion;
end;

procedure TNetFwAuthorizedApplicationProperties.Set_IpVersion
  (IpVersion: NET_FW_IP_VERSION_);
begin
  DefaultInterface.Set_IpVersion(IpVersion);
end;
...
procedure TNetFwAuthorizedApplicationProperties.Set_RemoteAddresses
  (const remoteAddrs: WideString);
{ Warning: The property RemoteAddresses has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant as a passthrough. }
var
...
class function CoNetFwPolicy2.CreateRemote(const MachineName: string)
  : INetFwPolicy2;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_NetFwPolicy2)
    as INetFwPolicy2;
end;

procedure TNetFwPolicy2.InitServerData;
const
  CServerData: TServerData = (ClassID: '{E2B3C97F-6AE1-41AC-817A-F6F92166D7DD}';
    IntfIID: '{98325047-C671-4174-8D81-DEFCD3F03186}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
function TNetFwPolicy2.Get_FirewallEnabled(profileType: NET_FW_PROFILE_TYPE2_)
  : WordBool;
begin
  Result := DefaultInterface.FirewallEnabled[profileType];
end;

procedure TNetFwPolicy2.Set_FirewallEnabled(profileType: NET_FW_PROFILE_TYPE2_;
  Enabled: WordBool);
begin
  DefaultInterface.FirewallEnabled[profileType] := Enabled;
end;

function TNetFwPolicy2.Get_ExcludedInterfaces(profileType
  : NET_FW_PROFILE_TYPE2_): OleVariant;
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TNetFwPolicy2.Set_ExcludedInterfaces(profileType
  : NET_FW_PROFILE_TYPE2_; Interfaces: OleVariant);
begin
  DefaultInterface.ExcludedInterfaces[profileType] := Interfaces;
end;

function TNetFwPolicy2.Get_BlockAllInboundTraffic
  (profileType: NET_FW_PROFILE_TYPE2_): WordBool;
begin
  Result := DefaultInterface.BlockAllInboundTraffic[profileType];
end;

procedure TNetFwPolicy2.Set_BlockAllInboundTraffic
  (profileType: NET_FW_PROFILE_TYPE2_; Block: WordBool);
begin
  DefaultInterface.BlockAllInboundTraffic[profileType] := Block;
end;

function TNetFwPolicy2.Get_NotificationsDisabled(profileType
  : NET_FW_PROFILE_TYPE2_): WordBool;
begin
  Result := DefaultInterface.NotificationsDisabled[profileType];
end;

procedure TNetFwPolicy2.Set_NotificationsDisabled
  (profileType: NET_FW_PROFILE_TYPE2_; disabled: WordBool);
begin
  DefaultInterface.NotificationsDisabled[profileType] := disabled;
end;

function TNetFwPolicy2.Get_UnicastResponsesToMulticastBroadcastDisabled
  (profileType: NET_FW_PROFILE_TYPE2_): WordBool;
begin
  Result := DefaultInterface.UnicastResponsesToMulticastBroadcastDisabled
    [profileType];
end;

procedure TNetFwPolicy2.Set_UnicastResponsesToMulticastBroadcastDisabled
  (profileType: NET_FW_PROFILE_TYPE2_; disabled: WordBool);
begin
  DefaultInterface.UnicastResponsesToMulticastBroadcastDisabled[profileType]
    := disabled;
end;
...
function TNetFwPolicy2.Get_DefaultInboundAction(profileType
  : NET_FW_PROFILE_TYPE2_): NET_FW_ACTION_;
begin
  Result := DefaultInterface.DefaultInboundAction[profileType];
end;

procedure TNetFwPolicy2.Set_DefaultInboundAction(profileType
  : NET_FW_PROFILE_TYPE2_; Action: NET_FW_ACTION_);
begin
  DefaultInterface.DefaultInboundAction[profileType] := Action;
end;

function TNetFwPolicy2.Get_DefaultOutboundAction(profileType
  : NET_FW_PROFILE_TYPE2_): NET_FW_ACTION_;
begin
  Result := DefaultInterface.DefaultOutboundAction[profileType];
end;

procedure TNetFwPolicy2.Set_DefaultOutboundAction
  (profileType: NET_FW_PROFILE_TYPE2_; Action: NET_FW_ACTION_);
begin
  DefaultInterface.DefaultOutboundAction[profileType] := Action;
end;

function TNetFwPolicy2.Get_IsRuleGroupCurrentlyEnabled(const group: WideString)
  : WordBool;
begin
...
procedure TNetFwPolicy2.EnableRuleGroup(profileTypesBitmask: Integer;
  const group: WideString; enable: WordBool);
begin
  DefaultInterface.EnableRuleGroup(profileTypesBitmask, group, enable);
end;

function TNetFwPolicy2.IsRuleGroupEnabled(profileTypesBitmask: Integer;
  const group: WideString): WordBool;
begin
...
function TNetFwPolicy2Properties.Get_FirewallEnabled
  (profileType: NET_FW_PROFILE_TYPE2_): WordBool;
begin
  Result := DefaultInterface.FirewallEnabled[profileType];
end;

procedure TNetFwPolicy2Properties.Set_FirewallEnabled
  (profileType: NET_FW_PROFILE_TYPE2_; Enabled: WordBool);
begin
  DefaultInterface.FirewallEnabled[profileType] := Enabled;
end;

function TNetFwPolicy2Properties.Get_ExcludedInterfaces
  (profileType: NET_FW_PROFILE_TYPE2_): OleVariant;
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TNetFwPolicy2Properties.Set_ExcludedInterfaces
  (profileType: NET_FW_PROFILE_TYPE2_; Interfaces: OleVariant);
begin
  DefaultInterface.ExcludedInterfaces[profileType] := Interfaces;
end;

function TNetFwPolicy2Properties.Get_BlockAllInboundTraffic
  (profileType: NET_FW_PROFILE_TYPE2_): WordBool;
begin
  Result := DefaultInterface.BlockAllInboundTraffic[profileType];
end;

procedure TNetFwPolicy2Properties.Set_BlockAllInboundTraffic
  (profileType: NET_FW_PROFILE_TYPE2_; Block: WordBool);
begin
  DefaultInterface.BlockAllInboundTraffic[profileType] := Block;
end;

function TNetFwPolicy2Properties.Get_NotificationsDisabled
  (profileType: NET_FW_PROFILE_TYPE2_): WordBool;
begin
  Result := DefaultInterface.NotificationsDisabled[profileType];
end;

procedure TNetFwPolicy2Properties.Set_NotificationsDisabled
  (profileType: NET_FW_PROFILE_TYPE2_; disabled: WordBool);
begin
  DefaultInterface.NotificationsDisabled[profileType] := disabled;
end;

function TNetFwPolicy2Properties.
...
procedure TNetFwPolicy2Properties.
  Set_UnicastResponsesToMulticastBroadcastDisabled
  (profileType: NET_FW_PROFILE_TYPE2_; disabled: WordBool);
begin
  DefaultInterface.UnicastResponsesToMulticastBroadcastDisabled[profileType]
    := disabled;
...
function TNetFwPolicy2Properties.Get_ServiceRestriction
  : INetFwServiceRestriction;
begin
  Result := DefaultInterface.ServiceRestriction;
end;

function TNetFwPolicy2Properties.Get_DefaultInboundAction
  (profileType: NET_FW_PROFILE_TYPE2_): NET_FW_ACTION_;
begin
  Result := DefaultInterface.DefaultInboundAction[profileType];
end;

procedure TNetFwPolicy2Properties.Set_DefaultInboundAction
  (profileType: NET_FW_PROFILE_TYPE2_; Action: NET_FW_ACTION_);
begin
  DefaultInterface.DefaultInboundAction[profileType] := Action;
end;

function TNetFwPolicy2Properties.Get_DefaultOutboundAction
  (profileType: NET_FW_PROFILE_TYPE2_): NET_FW_ACTION_;
begin
  Result := DefaultInterface.DefaultOutboundAction[profileType];
end;

procedure TNetFwPolicy2Properties.Set_DefaultOutboundAction
  (profileType: NET_FW_PROFILE_TYPE2_; Action: NET_FW_ACTION_);
begin
  DefaultInterface.DefaultOutboundAction[profileType] := Action;
end;

function TNetFwPolicy2Properties.Get_IsRuleGroupCurrentlyEnabled
  (const group: WideString): WordBool;
begin
  Result := DefaultInterface.IsRuleGroupCurrentlyEnabled[group];
end;

function TNetFwPolicy2Properties.Get_LocalPolicyModifyState
...
const
  CServerData: TServerData = (ClassID: '{304CE942-6E39-40D8-943A-B913C40C9CD4}';
    IntfIID: '{F7898AF5-CAC4-4632-A2EC-DA06E5111AF2}'; EventIID: '';
    LicenseKey: nil; Version: 500);
begin
  ServerData := @CServerData;
end;
...
procedure TNetFwMgr.IsPortAllowed(const imageFileName: WideString;
  IpVersion: NET_FW_IP_VERSION_; portNumber: Integer;
  const localAddress: WideString; ipProtocol: NET_FW_IP_PROTOCOL_;
  out allowed: OleVariant; out restricted: OleVariant);
begin
  DefaultInterface.IsPortAllowed(imageFileName, IpVersion, portNumber,
...
procedure TNetFwMgr.IsIcmpTypeAllowed(IpVersion: NET_FW_IP_VERSION_;
  ...
  out restricted: OleVariant);
begin
  DefaultInterface.IsIcmpTypeAllowed(IpVersion, localAddress, type_, allowed,
    restricted);
end;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TNetFwRule, TNetFwOpenPort,
    TNetFwAuthorizedApplication, TNetFwPolicy2, TNetFwMgr]);
end;
