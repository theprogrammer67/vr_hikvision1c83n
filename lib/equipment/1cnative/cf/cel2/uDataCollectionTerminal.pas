...
type
  ...
  // Перегруженные абстрактные методы типа оборудования
    procedure UploadTable(AInputParameters: IXMLDocument; const APackageStatus: string); overload; virtual; abstract;
    procedure DownloadTable(AOutputParameters: IXMLDocument); overload; virtual; abstract;
...
function TDataCollectionTerminal.UploadTable(RetValue: PV8Variant; Params: PV8ParamArray; const ParamCount: Integer;
...
function TDataCollectionTerminal.DownloadTable(RetValue: PV8Variant; Params: PV8ParamArray; const ParamCount: Integer;
  var v8: TV8AddInDefBase): Boolean;
var
...
function TDataCollectionTerminal.ClearTable(RetValue: PV8Variant; Params: PV8ParamArray; const ParamCount: Integer;
  var v8: TV8AddInDefBase): Boolean;
begin
  try
    ClearTable;
...
class procedure TDataCollectionTerminal.UpdateDriverInfo(ADriverInfo: PDriverInfo);
begin
  inherited;
